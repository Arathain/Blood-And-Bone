...
public class RigUtils {
    ...
    public static class BlendShape3D {
        ...
        public void evaluate(IBone bone, Vec3d dir) {
        ...
        public void evaluate(IBone bone, Vec3d d, boolean mirrorX) {
    ...
    {
        double tr = matrix.a00 + matrix.a11 + matrix.a22;
        double qw = 0;
        double qx = 0;
        double qy = 0;
        double qz = 0;
    ...
    public static Vec3f eulerAnglesXYZFromMatrix(Matrix4f matrix4f) {
        // From https://www.geometrictools.com/Documentation/EulerAngles.pdf
        float thetaZ;
        float thetaY;
        float thetaX;
